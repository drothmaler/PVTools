 ...
 * @param  {Object} params
 *      @param  {number} params.maxHeatTemp max temperature to calc
 *      @param  {number} [params.minHeatTemp] Optional: min temperature to calc
 *      @param  {Array<Array<number>>} params.tempMap Array of arrays with tempratures [ [0 , 40], [10 , 30] ] | First Value: outside, temprature, second value: water temprature
 * @return {Record<string, number>} {'-25': 55, '-24': 54,5, ... '15': 35} minHeatTemp -25, maxHeatTemp 15
 */

const calcHeatingTempMap = ({maxHeatTemp, minHeatTemp = -25, tempMap}) => {
 ...
 * @param  {Object} params
 *      @param  {number} params.maxHeatTemp max temperature to calc
 *      @param  {number} params.minHeatTemp min temperature to calc
 *      @param  {number} params.maxTargetTemp max target temperature
 *      @param  {number} params.minTargetTemp min target temperature
 *      @param  {Array<Array<number>>} params.efficiencyMap
 * @return {Record<number, Record<number, number>>}
 */
