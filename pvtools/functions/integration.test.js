...
const {energyFlow, normalizeHourlyRadiation, mergePowerGeneration, generateDayTimeValues, calculateConsumption} = require('./energyFlow')
...
describe.skip('integration', () => {
    ...
    test('energyFlow with real data on one day', () => {
        const genConsumption = powerGenAndConsumption.find(v => v.dayTime == '20200405:14')
    ...
    test('energyFlow calc year consumption and generation', () => {
        ...
        expect(generationYear > 19000*0.9 && generationYear < 19000*1.1).toEqual(true)
        expect(consumptionYear > 6000*0.9 && consumptionYear < 6000*1.1).toEqual(true)
    })
